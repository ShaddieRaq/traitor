import { useBots, useDeleteBot, useStartBot, useStopBot } from '../hooks/useBots';
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-xs text-gray-400">
                        Position Size: {bot.current_position_size}{bot.distance_to_signal ? ` • Distance: ${bot.distance_to_signal.toFixed(2)}` : ''}
                      </p>
